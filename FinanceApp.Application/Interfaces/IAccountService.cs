...
public interface IAccountService
{
    ...
    Task<IEnumerable<AccountDto>> GetAllAccountsAsync(Guid userId, ViewContext context, Guid? memberUserId = null);
    ...
    Task<IEnumerable<AccountDto>> GetActiveAccountsAsync(Guid userId, ViewContext context, Guid? memberUserId = null);
